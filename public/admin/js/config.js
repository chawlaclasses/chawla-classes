...
const ROLE_PERMISSIONS = {
    super_admin: ['*'],
    admin: ['dashboard:view','classes:*','subjects:*','series:*','tests:*','questions:*','homework:*','doubts:*','students:*','attendance:*','enquiries:*','admissions:*','fees:*','communication:*','ai:*','settings:view','settings:edit','audit:view','staff:view','staff:create','staff:edit','staff:deactivate','recruitment:*','marketing:*','reviews:*'],
